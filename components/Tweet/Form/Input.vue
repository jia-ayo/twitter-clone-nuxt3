    ...
    <div class="flex items-center flex-shrink-0 p-4 pb-0">
      ...
      <div class="w-full p-2">
        <textarea
          ...
          v-model="text"
          class="w-full block overflow-hidden resize-y max-h-52 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0 dark:text-white focus:ring-0"
        ></textarea>
      </div>
    </div>
    <!-- files selector -->
    ...
    <div class="flex p-2 pl-14">
      <div class="flex w-full text-white">
        <div
          ...
          class="p-2 text-blue-400 rounded-full hover:bg-blue-100 dark:hover:bg-dim-800 cursor-pointer"
        >
